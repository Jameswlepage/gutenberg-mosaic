...
function gutenberg_enable_experiments() {
	...
	if ( $gutenberg_experiments && array_key_exists( 'gutenberg-collapsed-sidebar-rail', $gutenberg_experiments ) ) {
		wp_add_inline_script( 'wp-block-editor', 'window.__experimentalCollapsedSidebarRail = true', 'before' );
	}
}
